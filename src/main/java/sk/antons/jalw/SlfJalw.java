...
/**
 * Factory class for creating Jalw instances for Slf4j logging framework.
...
public class SlfJalw {
    ...
    public static Jalw jalw(Logger logger) {
        return new Jalw(new SlfJalwLogger(logger));
    }
    
    private static class SlfJalwLogger implements JalwLogger {

        private Logger logger = null;
        public SlfJalwLogger(Logger logger) {
            this.logger = logger;
        }         
